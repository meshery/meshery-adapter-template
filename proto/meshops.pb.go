...
type SupportedOperation struct {
	...
	Category             OpCategory `protobuf:"varint,3,opt,name=category,proto3,enum=proto.OpCategory" json:"category,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func init() {
	proto.RegisterType((*CreateMeshInstanceRequest)(nil), "proto.CreateMeshInstanceRequest")
	proto.RegisterType((*CreateMeshInstanceResponse)(nil), "proto.CreateMeshInstanceResponse")
	proto.RegisterType((*MeshNameRequest)(nil), "proto.MeshNameRequest")
	proto.RegisterType((*MeshNameResponse)(nil), "proto.MeshNameResponse")
	proto.RegisterType((*ApplyRuleRequest)(nil), "proto.ApplyRuleRequest")
	proto.RegisterType((*ApplyRuleResponse)(nil), "proto.ApplyRuleResponse")
	proto.RegisterType((*SupportedOperationsRequest)(nil), "proto.SupportedOperationsRequest")
	proto.RegisterType((*SupportedOperationsResponse)(nil), "proto.SupportedOperationsResponse")
	proto.RegisterType((*SupportedOperation)(nil), "proto.SupportedOperation")
	proto.RegisterType((*EventsRequest)(nil), "proto.EventsRequest")
	proto.RegisterType((*EventsResponse)(nil), "proto.EventsResponse")
	proto.RegisterEnum("proto.OpCategory", OpCategory_name, OpCategory_value)
...
func (c *meshServiceClient) CreateMeshInstance(ctx context.Context, in *CreateMeshInstanceRequest, opts ...grpc.CallOption) (*CreateMeshInstanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MeshService/CreateMeshInstance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshServiceClient) MeshName(ctx context.Context, in *MeshNameRequest, opts ...grpc.CallOption) (*MeshNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MeshService/MeshName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshServiceClient) ApplyOperation(ctx context.Context, in *ApplyRuleRequest, opts ...grpc.CallOption) (*ApplyRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MeshService/ApplyOperation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshServiceClient) SupportedOperations(ctx context.Context, in *SupportedOperationsRequest, opts ...grpc.CallOption) (*SupportedOperationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.MeshService/SupportedOperations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshServiceClient) StreamEvents(ctx context.Context, in *EventsRequest, opts ...grpc.CallOption) (MeshService_StreamEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MeshService_serviceDesc.Streams[0], "/proto.MeshService/StreamEvents", opts...)
	if err != nil {
		return nil, err
	}
...
func _MeshService_CreateMeshInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MeshService/CreateMeshInstance",
	}
...
func _MeshService_MeshName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MeshService/MeshName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MeshService_ApplyOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MeshService/ApplyOperation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MeshService_SupportedOperations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MeshService/SupportedOperations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
